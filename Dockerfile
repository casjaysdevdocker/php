...
ARG IMAGE_NAME="php"
ARG PHP_SERVER="php"
ARG BUILD_DATE="Sun Aug  4 01:46:09 PM EDT 2024"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/php" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/php" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/php" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/php" \
