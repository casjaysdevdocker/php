...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410091047-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  05-php-fpm.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 09, 2024 10:47 EDT
# @@File             :  05-php-fpm.sh
# @@Description      :
...
# set data directory
DATA_DIR="/data/php-fpm"
# set config directory
CONF_DIR="/config/php-fpm"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "/config/env/php-fpm.script.sh" ] && . "/config/env/php-fpm.script.sh"
# Overwrite the variabes
[ -f "/config/env/php-fpm.sh" ] && . "/config/env/php-fpm.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
